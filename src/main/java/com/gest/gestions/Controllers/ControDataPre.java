...
public class ControDataPre {
    ...
    //**************
    @GetMapping("/patient/last/{id}")
    public ResponseEntity<?> findLastUser(@PathVariable Long id) {



        Data_pre donne1=repd.findLastUser(id);


        return new ResponseEntity<Data_pre>(donne1,HttpStatus.OK);
